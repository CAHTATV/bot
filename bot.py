...
MATCHES_TO_CHECK = 7
GOAL_THRESHOLD = 0.65      
MIN_ODDS = 1.30            # ИЗМЕНЕНИЕ: Снизили минимальный КФ до 1.30 по твоей просьбе
    ...
    while True:
        try:
            ...
            for match in data.get("response", []):
                ...
                odds_line = f"💰 Коэффициент: {odds:.2f}" if odds is not None else f"💰 Ставить в Live при КФ от {MIN_ODDS}"
