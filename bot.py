...
def odds_monitor_loop():
    while True:
        ...
        for m in queue_copy:
            ...
            # ИЗМЕНЕНИЕ: Искусственная задержка 6 секунд между отправкой РАЗНЫХ матчей в ТГ
    ...
    while True:
        try:
            ...
            for match in data.get("response", []):
                ...
                # ИЗМЕНЕНИЕ: Такая же пауза 6 секунд для Live-сигналов, если совпало несколько матчей
                time.sleep(6)
